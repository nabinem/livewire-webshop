            ...
            <div class="mt-10 sm:mt-0">
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <p class="mb-3">
                            Source: 
                            <a class="underline text-blue-600" href="https://www.youtube.com/watch?v=1_FndV_HfME&list=PLk50kBj85u6hgV_2916BQPs6DPpbAD8zD&index=2" target="_blank">
                                https://www.youtube.com/watch?v=1_FndV_HfME
                            </a>
                        </p>
                                    ...
                                    @if ($currentPage === 1)
                                        <div class="flex flex-col">
                                            <div class="w-full py-2">
                                                ...
                                                <input wire:model="firstName" type="text" name="first_name" id="first_name" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                                @error('firstName') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="w-full py-2">
                                                <label for="last_name" class="block text-sm font-medium text-gray-700">Last name</label>
                                                <input wire:model="lastName" type="text" name="last_name" id="last_name" autocomplete="family-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    ...
                                    @elseif ($currentPage === 2)
                                        <div class="flex flex-col">
                                            ...
                                            <div class="w-full py-2">
                                                ...
                                                <input wire:model="confirmPassword" type="password" name="password_confirmation" id="password_confirmation" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
