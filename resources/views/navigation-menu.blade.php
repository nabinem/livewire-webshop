        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="ms-3 relative inline-flex relative items-center px-1 pt-1">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        CRUD EXAMPLES <br>
                                        With Websocket Examples
                            ...
                            <x-slot name="content">
                                <x-dropdown-link wire:navigate href="{{ route('post') }}">
                                    {{ __('POST CRUD 1') }} With Websockets Example
                                </x-dropdown-link>
                    ...
                    <x-nav-link wire:navigate href="{{ route('modal') }}">
                        {{ __('MODAL EXAMPLES') }}
                    </x-nav-link>
